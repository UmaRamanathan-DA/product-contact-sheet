...
rolls = [
    ...
    },
    {
        ...
        "desc": "A retro-styled coffee app that gives coffee lovers &mdash; in-store ordering experience, turning ordering back into a ritual, coffee lovers would appreciate.",
        "frames": [
...
BODY_HTML = f'''<div class="wrap">
  <header class="masthead">
    ...
    <p class="intro">
      A quick snapshot of <strong>shipped and prototyped app design work</strong>,
